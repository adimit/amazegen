...
pub fn parse_configuration_from_string(str: String) -> Configuration {
...
mod tests {
    ...
    fn test_parse_configuration_from_string() {
        let config = parse_configuration_from_string("".into());
        assert_eq!(config, get_default_configuration());
    }

    #[test]
    fn parses_just_a_seed() {
        let config = parse_configuration_from_string("||1234".into());
